...
#跑步出來用絕對路徑
#tensorboard --logdir=C:\Users\CNN\Downloads\ShauYuYan\S\runs_0407_rp5
#--------------------------------------------------------
#                       import
#--------------------------------------------------------
...
class CBMIR():
    ...
    def auto_train(self):
        ...
        # 生成的文件路径为: runs_0407_rp5/Dec16_21-13-54_DESKTOP-E782FS1/
        ...
        writer = SummaryWriter('runs_0407_rp5')
                ...
                for path_list in range(len(self.path_listt)):
                    ...
                    for k in range(self.K):
                       ...
                       #繪製混淆矩陣
                        ...
                        #資料可視化
                        writer = SummaryWriter('runs_0407_rp5/'+str(self.train_typee[train_type])
                ...
                for path_list in range(len(self.path_listt)):  
                    for top in range(len(self.top_list)):
                        ...
                        for k in range(self.K):
                            ...
                            target_path = self.target_path +'\\'+ self.path_listt[path_list]
                            query_path =  self.query_path  +'\\'+ self.path_listt[path_list]
        ...
        def predict(path,model_path):   
            def img_predict(img_path,model):
                    ...
                    with open (probability_save, 'a+', newline='') as csvfile:
                        csv.writer(csvfile).writerow([img_path,pred,probability.item()])
                        csvfile.close()
                    if correct == 0:
...
#     cb.train_typee = ['trainFromScratch']
#     cb.path_listt=['S']
#     cb.num_epochs =20
#     cb.batch_size = 16
#     cb.top_list = [10]
